...
def main():
    ...
    output_file = os.path.join(RESULTS_DIR, f"intentie_api_V1_{descriere_set}_2.json")
    raport_file = os.path.join(RESULTS_DIR, f"intentie_api_V1_{descriere_set}_raport_2.txt")
