"""
Prompt V1 - Estimare Satisfactie - Modele Locale
Doua variante de prompt: get_prompt (varianta 1) si get_prompt2 (varianta 2).

Utilizare:
    python3 satisfactie_local_V1.py --model romistral
    python3 satisfactie_local_V1.py --model romistral --varianta 2
    python3 satisfactie_local_V1.py --model romistral --tot_setul
    python3 satisfactie_local_V1.py --model romistral --varianta 2 --tot_setul
"""
import json
import os
import sys
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Prompt V1 - Satisfactie - Modele Locale")
    ...
    print(f"\n=== PROMPT V1 varianta {args.varianta} — SATISFACTIE — MODELE LOCALE ===")
    ...
    output_file = os.path.join(RESULTS_DIR, f"satisfactie_local_{args.model}_V1{sufix_varianta}_{descriere_set}.json")
    raport_file = os.path.join(RESULTS_DIR, f"satisfactie_local_{args.model}_V1{sufix_varianta}_{descriere_set}_raport.txt")
